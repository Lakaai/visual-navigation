#ifndef MEASUREMENTSLAMIDENTICALTAGBUNDLE_H
#define MEASUREMENTSLAMIDENTICALTAGBUNDLE_H
...
{
public:
    MeasurementIdenticalTagBundle (double time, const Eigen::Matrix<double, 8, Eigen::Dynamic> & Y, const Camera & camera, const std::vector<int> & markerIds);
...
Scalar MeasurementIdenticalTagBundle::logLikelihood(const Eigen::VectorX<Scalar> & x, const SystemEstimator & system) const
{
...
template <typename Scalar>
Eigen::Vector2<Scalar> MeasurementIdenticalTagBundle::predictFeature(const Eigen::VectorX<Scalar> & x, const SystemSLAM & system, std::size_t idxLandmark) const
{
...
template <typename Scalar>
Eigen::VectorX<Scalar> MeasurementIdenticalTagBundle::predictFeatureBundle(const Eigen::VectorX<Scalar> & x, const SystemSLAM & system, const std::vector<std::size_t> & idxLandmarks) const
{
