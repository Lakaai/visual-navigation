...
//         Pose<double> & Tnc = validChessboardImages[k]->Tnc;
//         cv::Mat R;
...
//         Tnc.rotationMatrix = R_eigen;

//         Eigen::Vector3d rNCc_eigen;
//         cv::cv2eigen(rNCc_all[k], rNCc_eigen);
//         Tnc.translationVector = rNCc_eigen;
...
// //     // Camera cameraMatrix
// //     // TODO
// //     // Use cv::projectPoints to project the 3D point to the image plane
// //     cv::projectPoints(rPCc, cv::Mat::zeros(3, 1, CV_64F), cv::Mat::zeros(3, 1, CV_64F), Camera::cameraMatrix, Camera::distCoeffs, imagePoints);	
    
// //     return rQOi(imagePoints[0].x, imagePoints[0].y);
// // }
// {
