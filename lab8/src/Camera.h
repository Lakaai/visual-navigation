...
struct Camera
{
    ...
    Pose<double> cameraToBody(const Pose<double> & Tnc) const;              // Convert camera pose Tnc to body pose Tnb
    Pose<double> bodyToCamera(const Pose<double> & Tnb) const;              // Convert body pose Tnb to camera pose Tnc
