...
#ifndef SYSTEMESTIMATORAUGMENTED_H
#define SYSTEMESTIMATORAUGMENTED_H
 ...
 */
class SystemEstimatorAugmented : public SystemBase
{
public:
    /**
     ...
     */
    SystemEstimatorAugmented(const GaussianInfo<double> & density);

    /**
     * @brief Destroy the SystemEstimator object.
     */
    virtual ~SystemEstimatorAugmented();
